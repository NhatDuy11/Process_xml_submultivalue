...
public class FlattenXmlUdf {
    public static int PRETTY_PRINT_INDENT_FACTOR = 4;

    public String flattenXml(String xmlString, String columnList) {
        ...
        try {
            ...
            List<String> columnsToExtract = Arrays.asList(columnList.split(","));
            JSONObject flattened = flattenObject(row, columnsToExtract);
            long endTime = System.nanoTime();
            System.out.println("endTime : " + endTime);
            double durationInSeconds = (endTime - startTime) / 1_000_000_000.0; // Chia cho 1 tỷ để chuyển đổi thành giây
            System.out.println("Total execution time: " + durationInSeconds + " seconds");
            return flattened.toString(PRETTY_PRINT_INDENT_FACTOR);
    ...
    private JSONObject flattenObject(JSONObject jsonObject, List<String> columnsToExtract) throws JSONException {
        JSONObject result = new JSONObject();
        for (String key : jsonObject.keySet()) {
            if (columnsToExtract.contains(key)) {
    ...
    private String flattenArray(JSONArray jsonArray) throws JSONException {
    ...
    private String flattenSingleObject(JSONObject jsonObject) throws JSONException {
    ...
    public static void main(String[] args) {
        FlattenXmlUdf flatten = new FlattenXmlUdf();
        String xmlString = "<row id=\"75825\">\n" +
                ...
                "  <c219>1</c219>\n" +
                "</row>";
        String result = flatten.flattenXml(xmlString,"c217,c157");
